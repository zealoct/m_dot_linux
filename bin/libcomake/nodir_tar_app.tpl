...
__$FNAME$___IDLSRCCPP := $(patsubst %.idl,%.cpp, $(notdir $(__$FNAME$___IDLSRC)))
__$FNAME$___IDLSRCH := $(patsubst %.idl,%.h, $(notdir $(__$FNAME$___IDLSRC)))
...
__$FNAME$___IDLOBJS := $(__$FNAME$___IDLSRCCPP:.cpp=.o)
__$FNAME$___OBJS += $(__$FNAME$___IDLOBJS)
...
$(__$FNAME$___IDLOBJS) : $(__$FNAME$___IDLSRC)
	$(foreach n, $(__$FNAME$___IDLSRC), $(IDLCC) --ns=$(basename $(notdir $(n))) -o $(basename $(notdir $(n))) $(n) $(CPPFLAGS) $(INCPATH);)
	$(foreach n, $(__$FNAME$___IDLSRC), $(CXX) -c -o  $(basename $(notdir $(n))).o $(basename $(notdir $(n))).cpp  $(CXXFLAGS) $(CPPFLAGS) $(INCPATH);)
