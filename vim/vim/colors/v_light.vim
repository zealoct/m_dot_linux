...
hi IncSearch    term=reverse cterm=none ctermfg=White ctermbg=Black gui=reverse
hi Search       term=reverse,bold cterm=bold ctermfg=7 ctermbg=6 guifg=NONE guibg=Blue
hi MoreMsg      term=bold ctermfg=2 gui=bold guifg=SeaGreen
hi ModeMsg      term=bold cterm=bold gui=bold
hi LineNr       term=underline ctermfg=3 gui=none guifg=Brown
hi Question     term=standout ctermfg=2 gui=bold guifg=SeaGreen
hi StatusLine   term=bold,none cterm=none ctermfg=0 ctermbg=7 gui=bold,reverse
hi StatusLineNC term=bold,none cterm=bold,none ctermfg=0 ctermbg=7 gui=reverse
hi VertSplit    term=none cterm=none ctermbg=7 gui=reverse
hi Title        term=bold ctermfg=5 gui=bold guifg=Magenta
hi Visual       term=reverse cterm=none ctermbg=0 guibg=LightGray
hi VisualNOS    term=bold,underline cterm=underline ctermfg=8 gui=bold,underline
...
hi PmenuSbar    cterm=none ctermfg=LightGray ctermbg=DarkGray guibg=DarkGray
hi PmenuThumb   cterm=none ctermfg=LightGray ctermbg=Black guibg=Black
...
hi Constant     term=underline cterm=bold ctermfg=4
...
hi Type         term=underline cterm=bold ctermfg=4 guifg=Blue
hi Underlined   term=underline cterm=underline ctermfg=11 gui=underline guifg=SlateBlue
hi Ignore       ctermfg=15 guifg=bg
hi Error        term=reverse ctermfg=10 ctermbg=12 guifg=White guibg=Red
hi Todo         cterm=bold ctermfg=0 ctermbg=7 guifg=Blue guibg=Yellow
hi ShowMarksHLl  cterm=bold ctermfg=0 ctermbg=7
" vim: sw=2
