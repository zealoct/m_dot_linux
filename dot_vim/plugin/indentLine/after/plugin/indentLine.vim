...
function! s:InitColor()
    ...
    execute "highlight Conceal ctermbg=" . term_color . " ctermfg=NONE"
    execute "highlight Conceal guibg=" . gui_color .  " guifg=NONE"
    ...
    if &term ==# "linux"
        ...
        execute "highlight Conceal cterm=bold ctermbg=" . tty_color .  " ctermfg=NONE"
    endif
endfunction
